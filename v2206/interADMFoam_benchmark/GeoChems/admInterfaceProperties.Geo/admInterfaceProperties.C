...
void Foam::admInterfaceProperties::correctContactAngle
(
...
void Foam::admInterfaceProperties::calculateK()
{
    const fvMesh& mesh = alpha1_.mesh();
...
Foam::admInterfaceProperties::admInterfaceProperties
(
    ...
    )
{
    ...
    calculateK();
    Info<< "interface contructed"<< endl;
}
...
Foam::admInterfaceProperties::sigmaK() const
{
...
Foam::admInterfaceProperties::surfaceTensionForce() const
{
...
Foam::tmp<Foam::volScalarField>
Foam::admInterfaceProperties::nearInterface() const
{
...
bool Foam::admInterfaceProperties::read()
{
