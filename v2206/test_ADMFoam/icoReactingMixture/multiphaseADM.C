...
{
    defineTypeNameAndDebug(multiphaseADM, 0);
    defineRunTimeSelectionTable(multiphaseADM, dictionary);
}
}
 
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //
 
Foam::multiphaseInter::multiphaseADM::multiphaseADM
(
     const fvMesh& mesh
)
:
...
void Foam::multiphaseInter::multiphaseADM::calculateSuSp()
{
    this->alphaTransfer(Su_, Sp_);
}
 
 
void Foam::multiphaseInter::multiphaseADM::solve()
{
...
void Foam::multiphaseInter::multiphaseADM::solveAlphas()
{
...
Foam::multiphaseInter::multiphaseADM::phases() const
{
    return phases_;
}
...
Foam::multiphaseInter::multiphaseADM::phases()
{
    return phases_;
}
...
Foam::multiphaseInter::multiphaseADM::phase(const label i) const
{
    return phases_[i];
}
...
Foam::multiphaseInter::multiphaseADM::phase(const label i)
{
    return phases_[i];
}
...
Foam::multiphaseInter::multiphaseADM::ddtAlphaMax() const
{
    return ddtAlphaMax_;
}
...
Foam::scalar
Foam::multiphaseInter::multiphaseADM::maxDiffNo() const
{
...
const Foam::multiphaseInter::multiphaseADM::compressionFluxTable&
Foam::multiphaseInter::multiphaseADM::limitedPhiAlphas() const
{
    return limitedPhiAlphas_;
}
 
 
Foam::multiphaseInter::multiphaseADM::SuSpTable&
Foam::multiphaseInter::multiphaseADM::Su()
{
    return Su_;
}
...
Foam::multiphaseInter::multiphaseADM::SuSpTable&
Foam::multiphaseInter::multiphaseADM::Sp()
{
    return Sp_;
}
 
 
bool Foam::multiphaseInter::multiphaseADM::read()
{
    return true;
}
